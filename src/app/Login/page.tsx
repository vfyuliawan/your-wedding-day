                ...
                <div className="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1 mt-2">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                            ...
                            <a   onClick={() => router.push('/forgot-password')} className="text-body text-bold ">Forgot password?</a>
                        </div>
                        <div className="text-center text-lg-start mt-4 pt-2">
                            ...
                            <p className="small fw-bold mt-2 pt-1 mb-0">Don't have an account?{' '}
                                <a  onClick={() => router.push('signup')}   className="text-body text-bold text-yellow">
                                Sign Up
                                </a>
                            </p>
                        </div> 
