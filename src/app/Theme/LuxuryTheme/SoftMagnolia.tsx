...
import FooterView from "./Section/Footer/SoftMagnoli/FooterView";
...
import HeathProtocol from "./Section/HealtProtocol/SoftMagnoli/HealthProtocol";
import LiveIgAndLinkFilter from "./Section/LiveIgAndFilter/SoftMagnoli/LivveIgAndFilter";
import HeroView from "./Section/Hero/SoftMagnolia/HeroView";
import MaleFemaleView from "./Section/Male-Female/SoftMagnoli/MaleFemaleView";
import InfoView from "./Section/Info/SoftMagnoli/InfoView";
import GaleryView from './Section/Galery/SoftMagnoli/GaleryView';

interface SoftMagnoliaInterface {
...
const SoftMagnolia = (props: SoftMagnoliaInterface) => {
