...
const HeaderView = (props: HeaderViewInterface) => {
  return (
    <div>
      ...
      />
      <link
        href="https://fonts.googleapis.com/css2?family=Belleza&family=Corinthia:wght@400;700&family=Delius+Swash+Caps&family=Forum&family=Homemade+Apple&family=Lavishly+Yours&family=Monsieur+La+Doulaise&family=Parisienne&family=Playwrite+GB+S:ital,wght@0,100..400;1,100..400&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet"
      />
      {/* FONT */}
      {/* simplycountdown */}
      ...
      <link
        rel="stylesheet"
        href={`/ThemeStyle/RedEssence/assets/css/style.css`}
      />
    </div>
  );
};
