...
const MaleFemaleView = (props: MaleFemaleViewInterface) => {
  ...
  return (
    ...
    >
      <img
        src="/image/soft_magnolia/MaleFemaleBg.jpeg"
        style={{
          width: "100%",
          height: "100%",
          objectFit: "cover",
      ...
      <div
        style={{
          background:
            "linear-gradient(to bottom, var(--prim) 20%, transparent)",
          width: "100%",
          height: 180,
          position: "absolute",
          top: 0,
    ...
    return (
      ...
      >
        ...
        >
          <img
            src={
              props.title.includes("Template") && !params.right
                ? "/image/background/male.jpeg"
                : props.title.includes("Template") && params.right
                ? "/image/background/female.jpeg"
                : params.photo
            }
            style={{
              objectFit: "cover",
        ...
        <div
          style={{
            ...
            overflow: "hidden",
            backgroundColor: "transparent",
            borderTop: "3px solid var(--third)", 
            borderLeft: "3px solid var(--third)",
            borderRight: "3px solid var(--third)", 
            borderBottom : "3px solid var(--third)",
            borderTopLeftRadius: 80,
            borderTopRightRadius: 80,
            position: "absolute",
            top: 27,
        ...
        <div
          style={{
            ...
            position: "absolute",
            top: 220,
            left: isMobile && params.right ? -40 : 0,
            zIndex: 2,
          }}
        >
          <div
