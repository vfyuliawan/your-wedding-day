      ...
      {!appear && (
        <motion.div
          ...
          style={{
            ...
            zIndex: 999,
            backgroundColor: appear ? "var(--third)" : "var(--third)",
          }}
        >
          <div
            className="figure"
          ...
          >
            <div
              style={{
                ...
                backgroundImage: props.detailCover?.title.includes("Template")
                  ? `url("/image/background/prewed4.jpeg")`
                  : `url(${props.detailCover?.img})`,
            ...
            <div
              style={{
                ...
                overflow: "hidden",
                // backgroundImage: `url(${props.detailCover?.img})`,
                backgroundImage: `url("/image/soft_magnolia/coverImg4.png")`,
                backgroundPosition: "center",
            ...
            <div
              style={{
                ...
                justifyContent: "center",
                alignItems: "flex-start", // Aligns content at the top of the div
                overflow: "hidden",
              }}
            ></div>
            ...
            <div
              style={{
                ...
                height: "50vh",
                background:
                  "linear-gradient(to top, var(--prim) 60%, transparent 100%)",
                bottom: 0,
                justifyContent: "center",
                alignItems: "flex-start",
                overflow: "hidden",
            ...
            >
              <div
                style={{
                  ...
                  bottom: 0,
                  right: isMobile ? -180 : 0,
                  overflow: "hidden", // Changed from "cover" to "hidden" for correct overflow handling
                }}
              >
                <img
                  style={{
                    ...
                    width: "100%",
                    objectFit: "fill",
                    transform: "rotate(180deg) scaleX(-1)", // Rotate and mirror the image
                  }}
                  src="/image/soft_magnolia/coverImg2.webp"
                  alt=""
                />
              </div>
            </div>
