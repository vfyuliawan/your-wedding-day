...
import { InfoAcara } from "../../../../../Manifest/Domain/Models/ModelResponse/ModelResponseDetailSlug/ModelResponseDetailSlug";
...
const InfoView = (props: InfoViewInterface) => {
  ...
  return (
    <section
      style={{ backgroundColor: "var(--third)" , marginBottom:isMobile ?-35 : -60}}
      id="info"
      className="info "
    >
          ...
          <div className="col-5 text-center">
            ...
            >
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
                style={{
                  fontWeight: 100,
                  fontFamily: IConstantFont.Corinthia,
                  marginTop: 40,
                  marginRight: 80,
                  fontSize: 42,
                  color:"var(--sec)"
              ...
              transition={{ duration: 0.5, delay: 0.4 }}
                style={{
                  ...
                  fontWeight:200,
                  color:"var(--sec)",
                  marginTop: -30, // Adds 2px space above this heading
                }}
              >
                Event
              </motion.h3>
