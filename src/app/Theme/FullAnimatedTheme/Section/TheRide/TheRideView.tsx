...
import { HomeKeyValue } from "@/app/Theme/FloralTheme/Section/Home/HomeModel";
...
import { MaleFemaleProps } from "@/app/Theme/FloralTheme/Section/Male-Female/MaleFemaleModel";

const TheRideView = (props: {
  themeName: string;
            ...
            <div className="row justify-content-center">
              ...
              <div className="">
                ...
                >
                  ...
                  >
                    Ibu {props.maleFemale.Female.Ibu}
                  </h4>
